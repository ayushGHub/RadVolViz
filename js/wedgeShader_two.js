function init() {
	...
	var rotateVarN = 0.0;
        ...
        var LENS2 = gui.addFolder("LENS2");
        LENS2.add(guiControls,'radiusR',0.0,156.0).step(1.0).name('LENS RADIUS');
        LENS2.add(guiControls,'xValue',-140.0,140.0).step(1.0).name('MOVE-X');
        LENS2.add(guiControls,'yValue',-140.0,140.0).step(1.0).name('MOVE-Y');
			...
			//	var transferTexture = updateTransferFunction();
				...
				materialSecondPass = new THREE.ShaderMaterial( {
					...
					uniforms: {	tex:  { type: "t", value: rtTexture },
								...
								cubeTex:  { type: "t", value: cubeTextures['d3'] },
								cubeTex2:  { type: "t", value: cubeTextures['Default'] },
